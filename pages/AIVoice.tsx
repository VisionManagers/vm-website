            ...
            <Reveal className="grid md:grid-cols-2 gap-12 items-center border border-slate-200 rounded-sm bg-white p-8 md:p-14">
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-8">
                  ...
                  and over 700 calls answered since January 2026 — about 90 potential patients a month who would
                  otherwise have gone to voicemail.
                </p>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[['~90', 'Potential patients / mo'], ['$4,300+', 'Booked in 2 days'], ['700+', 'Calls so far']].map(([num, label]) => (
