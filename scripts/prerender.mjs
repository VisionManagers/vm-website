...
const ROUTE_META = {
  ...
  '/bid-bot':         { priority: '0.9', changefreq: 'monthly' },
  '/market-test':     { priority: '0.9', changefreq: 'monthly' },
  '/partner':         { priority: '0.9', changefreq: 'monthly' },
  '/leak-audit':      { priority: '0.9', changefreq: 'monthly' },
  '/expansion-os':    { priority: '0.9', changefreq: 'monthly' },
  ...
  '/lab/workbench':   { priority: '0.8', changefreq: 'monthly' },
